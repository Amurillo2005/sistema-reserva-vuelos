...
const Flight = () => {
  return (
	<div className=" w-[400px] h-full mx-auto z-10 rounded-3xl">
				...
				<div className="flex-none sm:flex">
                  ...
                  <img src="https://image.winudf.com/v2/image1/Y29tLmJldHMuYWlyaW5kaWEudWlfaWNvbl8xNTU0NTM4MzcxXzA0Mw/icon.png?w=&amp;fakeurl=1" className="h-8 p-1"/>
						...
						<div className="flex items-center">
							...
							<div className="border-b-2 border-dashed my-5 pt-5"></div>
							...
							<div className="flex flex-col py-5  justify-center text-sm ">
								<h6 className="font-bold text-center">tokenQR de paso a abordar</h6>
								{/* Code QR */}
                <QRcode/>
							</div>
						</div>
